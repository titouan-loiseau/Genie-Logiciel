...
public class GUI  implements ActionListener 
{
    ...
    private JTextField m_saisie_retier;
    ...
    public GUI(DossierBancaire d)
    {
        ...
        //Element saisie depot
        m_saisie_retier = new JTextField (20);
        m_saisie_retier.addActionListener(this);
        ...
        frame.getContentPane().add(new JLabel("Retier"));
        frame.getContentPane().add(m_saisie_retier);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if( e.getSource() == m_saisie_retier )
    	{
    		float retirer_value=Float.parseFloat(m_saisie_retier.getText());
    		try {
